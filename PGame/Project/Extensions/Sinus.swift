...
class NetworkService {
    ...
    @AppStorage("decodedStringURL") var decodedStringURL: String = ""
            ...
            DispatchQueue.main.async {
                ...
                do {
                    ...
                    if let jsonObject = try JSONSerialization.jsonObject(with: data, options: []) as? [String: Any] {
                        ...
                        if let urlValue = jsonObject[DataManager().urlCodeTech] as? String {
                            
                            self.decodedStringURL = decodeBase64(urlValue) ?? "not_decoded"
                            print(self.decodedStringURL)
                        }
